...
Note however that, since graph instances can support parallel edges, you might want to avoid using the second way since it will always only target the first matching edge (in insertion order).
