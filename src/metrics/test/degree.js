...
describe('Degrees', function () {
  describe('degree', function () {
    ...
    it('should calculate all degrees in a directed graph.', function () {
      assert.deepEqual(degree(createGraph('directed')), {1: 2, 2: 3, 3: 3});
    });
    it('should calculate all degrees in an undirected graph.', function () {
      assert.deepEqual(degree(createGraph('undirected')), {1: 2, 2: 2, 3: 2});
    });
    it('should calculate all degrees in an multi mixed graph.', function () {
      ...
      assert.deepEqual(degree(graph), {1: 4, 2: 3, 3: 3});

      graph.addDirectedEdge(1, 3);
      graph.addDirectedEdge(2, 2);

      assert.deepEqual(degree(graph), {1: 5, 2: 5, 3: 4});
    });
    it('should assign all degrees to their nodes', function () {
      var graph = createGraph('directed');
      degree.assign(graph);
      assert.equal(graph.getNodeAttribute('1', 'degree'), 2);
    });
    it('should assign all degrees to their nodes with custom name', function () {
      ...
      assert.equal(graph.getNodeAttribute('1', 'caracole'), 2);
    });
  });
  describe('inDegree', function () {
    ...
    it('should calculate all inDegrees', function () {
      assert.deepEqual(inDegree(createGraph('directed')), {1: 1, 2: 2, 3: 1});
    });
    it('should assign to graph', function () {
      var graph = createGraph('directed');
      inDegree.assign(graph);
      assert.equal(graph.getNodeAttribute(1, 'inDegree'), 1);
    });
    it('should assign all degrees to their nodes with custom name', function () {
      var graph = createGraph('directed');
      inDegree.assign(graph, {
      ...
      assert.equal(graph.getNodeAttribute(1, 'caracole'), 1);
    });
  });
  describe('outDegree', function () {
    ...
    it('should calculate all outDegrees', function () {
      assert.deepEqual(outDegree(createGraph('directed')), {
        1: 1,
        2: 1,
        3: 2
      });
    ...
    it('should assign to graph', function () {
      ...
      assert.equal(graph.getNodeAttribute(1, 'outDegree'), 1);
    });
    it('should assign all degrees to their nodes with custom name', function () {
      var graph = createGraph('directed');
      outDegree.assign(graph, {
  ...
  describe('undirectedDegree', function () {
    ...
    it('should calculate all undirected degrees', function () {
      assert.deepEqual(undirectedDegree(createGraph('undirected')), {
        1: 2,
        2: 2,
        3: 2
      });
    ...
    it('should assign to graph', function () {
      ...
      assert.equal(graph.getNodeAttribute(1, 'undirectedDegree'), 2);
    });
    it('should assign all degrees to their nodes with custom name', function () {
      var graph = createGraph('undirected');
      undirectedDegree.assign(graph, {
  ...
  describe('directedDegree', function () {
    ...
    it('should calculate all directed degrees', function () {
      assert.deepEqual(directedDegree(createGraph('directed')), {
        1: 2,
        2: 3,
        3: 3
      });
    ...
    it('should assign to graph', function () {
      ...
      assert.equal(graph.getNodeAttribute(1, 'directedDegree'), 2);
    });
    it('should assign all degrees to their nodes with custom name', function () {
      var graph = createGraph('directed');
      directedDegree.assign(graph, {
  ...
  describe('allDegree', function () {
    ...
    it('should calculate all degrees parameters on a directed graph', function () {
      assert.deepEqual(allDegree(createGraph('directed')), {
        1: {
          inDegree: 1,
          outDegree: 1
        },
    ...
    it('should calculate all degrees parameters on an undirected graph', function () {
      assert.deepEqual(allDegree(createGraph('undirected')), {
        1: {
          undirectedDegree: 2
        },
        2: {
    ...
    it('should calculate all degrees parameters on a mixed multi graph', function () {
      ...
      assert.deepEqual(allDegree(graph), {
        1: {
          inDegree: 0,
          outDegree: 2,
          undirectedDegree: 2
    ...
    it('should assign', function () {
      ...
      assert.equal(graph.getNodeAttribute(1, 'inDegree'), 1);
      assert.equal(graph.getNodeAttribute(2, 'inDegree'), 2);
      assert.equal(graph.getNodeAttribute(3, 'inDegree'), 1);
    });
    it('should assign with customized names', function () {
      ...
      assert.equal(graph.getNodeAttribute(1, 'in'), 1);
      assert.equal(graph.getNodeAttribute(2, 'in'), 2);
      assert.equal(graph.getNodeAttribute(3, 'in'), 1);
    });
  });
});
